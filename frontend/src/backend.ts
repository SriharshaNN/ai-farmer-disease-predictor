...
export class Backend implements backendInterface {
    ...
    async addPredictionRecord(arg0: AddPredictionRecordRequest): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPredictionRecord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPredictionRecordById(arg0: bigint): Promise<PredictionRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.getPredictionRecordById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecordsBySessionId(arg0: bigint): Promise<Array<PredictionRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecordsBySessionId(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
